...
After 13 years building frontend infrastructure at scale, I spent the last 12 weeks building my own — a consulting practice (Sherpa), a production product (WavePoint), and the AI dev tooling that made both possible (Sherpa Studio). The throughline: **I didn't just use AI tools — I built the infrastructure that makes AI-assisted development reliable, shipped production products on it, and founded a consulting practice around it.**

I'm looking for a Staff+ role where the velocity I demonstrated solo (472+ PRs, 11 weeks, 7 platforms) can compound inside a team. Linear is the current #1 target based on product overlap and culture alignment.

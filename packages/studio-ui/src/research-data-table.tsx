...
import type { SaturnQuarterCycleEvent } from "@/lib/studio/types";
import { cn } from "./lib/utils";

type SortKey = "date" | "longitude" | "daysToRecession";
type SortDir = "asc" | "desc";

interface ResearchDataTableProps {
  events: SaturnQuarterCycleEvent[];
}

export function ResearchDataTable({ events }: ResearchDataTableProps) {
  ...
  const sorted = [...events].sort((a, b) => {
    ...
    switch (sortKey) {
      ...
      case "longitude":
        return (a.longitude - b.longitude) * dir;
        ...
        <tbody>
          {sorted.map((event) => (
            ...
            >
              ...
              <td className="py-2">
                {event.longitude}° — {event.quadrant}
              </td>

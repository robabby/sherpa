...
The `docs/` directory follows the [directoturtle convention](/docs/concepts/directoturtle) — a recursive, self-similar structure where any file can expand into a directory without changing its logical path.
...
- [Initiative Lifecycle](/docs/concepts/initiative-lifecycle) — How proposals move through governance
